...
function ProviderIcon({ provider }: { provider: SocialAuthMethod }) {
  ...
  if (provider === "facebook") {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true" className="size-5">
        <path fill="#1877F2" d="M22 12A10 10 0 1 0 10.44 21.9v-7H7.9V12h2.54V9.8c0-2.51 1.5-3.9 3.78-3.9 1.1 0 2.24.2 2.24.2v2.46H15.2c-1.24 0-1.63.77-1.63 1.56V12h2.77l-.44 2.9h-2.33v7A10 10 0 0 0 22 12Z" />
        <path fill="#fff" d="m15.9 14.9.44-2.9h-2.77v-1.88c0-.79.39-1.56 1.63-1.56h1.26V6.1s-1.15-.2-2.24-.2c-2.28 0-3.78 1.39-3.78 3.9V12H7.9v2.9h2.54v7a10.1 10.1 0 0 0 3.13 0v-7h2.33Z" />
      </svg>
    );
  }
  return (
