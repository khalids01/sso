# SkyCanvas Studio Identity Branding

This file records the applied product branding for this repository.

The runtime source of truth is
`apps/web/src/constants/branding.ts`. Update that file first when consent-screen
or public identity details change.

## Product Values

- Product name: `SkyCanvas Studio Identity`
- Short text logo: `SkyCanvas Studio Identity`
- Package/app slug: `sso`
- Redis key prefix: `sso:`
- One-line description: `The secure account and single sign-on service operated by SkyCanvas Studio for its connected applications.`

## Branding Rules

- Use `SkyCanvas Studio Identity` for consent-facing product text, page metadata, legal pages, emails, navigation, and documentation.
